...
//       await Promise.all(
//         orders.map((order) => {
//           const { user, cart, address } = order;

//           // Fire all products in parallel for this order
//           return Promise.all(
//             cart.map((product) =>
...
//         const { user, cart, address, finalAmount } = order;
...
//                                 src={phonePeQr}
//                                 alt="UPI QR Code"
//                                 style={{ width: "200px", cursor: "pointer", objectFit: "cover", marginLeft: "10px" }}
